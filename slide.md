...
* **Falcon: Latências Quase Constantes e Previsíveis**
    ...
    * 30 ms I/O: `p(95)` ≈ 95 ms (basicamente, `avg` + tempo de I/O)
    * 150 ms I/O: `p(95)` ≈ 158 ms (basicamente, `avg` + tempo de I/O)
    * 1 s I/O: `p(95)` ≈ 1.04 s (basicamente, `avg` + tempo de I/O)
    * **A latência do Falcon escala linearmente com o tempo de I/O, e o `p(95)` fica muito próximo da média.**

* **Puma: Enormes "Caudas Longas" (p90/p95) com Bloqueio**
